...
struct MarkerSpec<Evidence> {
    relative_path: &'static str,
    evidence: Evidence,
}

const ROOT_MARKERS: &[MarkerSpec<RootEvidence>] = &[];

const COMPONENT_MARKERS: &[MarkerSpec<ComponentEvidence>] = &[
    MarkerSpec {
...
const BUILD_MARKERS: &[MarkerSpec<BuildEvidence>] = &[MarkerSpec {
    relative_path: "CMakeLists.txt",
    evidence: BuildEvidence::CMake,
}];

const OPERATIONAL_MARKERS: &[MarkerSpec<OperationalEvidence>] = &[
    MarkerSpec {
